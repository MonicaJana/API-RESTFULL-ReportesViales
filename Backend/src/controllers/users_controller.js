...
const perfil = (req,res)=>{
    try {
        // Asume que req.userBDD contiene los datos del usuario
        const userBDD = { ...req.userBDD };

        // Eliminar las propiedades no deseadas
        delete userBDD.token;
        delete userBDD.confirmarEmail;
        delete userBDD.createdAt;
        delete userBDD.updatedAt;
        delete userBDD.__v;
